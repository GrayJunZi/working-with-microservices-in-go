...
func (app *Config) sendMail(w http.ResponseWriter, msg MailPayload) {
	...
	mailURL := "http://mail-services/send"
...
func (app *Config) logItem(w http.ResponseWriter, entry LogPayload) {
	...
	logURL := "http://logger-services/log"
...
func (app *Config) logViaGRPC(w http.ResponseWriter, r *http.Request) {
	...
	conn, err := grpc.Dial("logger-services:50001", grpc.WithTransportCredentials(insecure.NewCredentials()), grpc.WithBlock())
	if err != nil {
		app.errorJSON(w, err)
		return
	}
